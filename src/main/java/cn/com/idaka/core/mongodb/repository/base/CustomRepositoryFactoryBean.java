...
public class CustomRepositoryFactoryBean<R extends MongoRepository<T, I>, T, I extends Serializable>
	...
	protected RepositoryFactorySupport getFactoryInstance(
		...
		return new CustomMongoRepositoryFactory<T,I>( operations );
	}
	
	private static class CustomMongoRepositoryFactory<T, ID extends Serializable>
		...
		protected Object getTargetRepository(RepositoryMetadata metadata) {
			...
			return new CustomRepositoryImpl<T, ID>( mongometa,  mongo);
		}

		protected Class<?> getRepositoryBaseClass(RepositoryMetadata metadata) {
			return CustomRepositoryBase.class;
		}
	}
}